...
\begin{itemize}
  \item (1)
        ...
        于是任意$x \in (a, x_0]$上，总有$f(x) = f(a)$，
        因为如果存在$x \in (a, x_0], f(x) \neq f(x_0)$，
        则在区间$[a, x_0]$上$f(x)$连续，在$(a, x_0)$上可导，
        由罗尔定理可知，存在$\xi \in (a, x_0)$，使得$f'(\xi) = 0$，
        与定理6.4矛盾。
        另外，$f(x)$在区间$(a, x_0]$是常数$f(a)$，与$f$在$(a, b)$上严格单调性矛盾。
        综上，假设不成立。
