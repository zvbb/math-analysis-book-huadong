...
\begin{itemize}
  ...
  \item (4)
        ...
        \end{align*}
        $\sum \frac{1}{n^2}$收敛，由优级数判别法可知，
        $\sum \frac{x^n}{n^2}$一致收敛。
  ...
  \item (5)
        ...
        考虑
        \begin{align*}
          \sup\limits_{x \in (-\infty, \infty)} |v_n(x) - f(x)|
           & = \sup\limits_{x \in (-\infty, \infty)} \frac{1}{x^2 + n} \\
           & = \frac{1}{n}
        \end{align*}
        于是
        \begin{align*}
          \lim\limits_{n \to \infty} \sup\limits_{x \in (-\infty, \infty)} |v_n(x) - f(x)|
           ...
           & = 0
        \end{align*}
        故$v_n(x) \rightrightarrows 0$。

        综上，由A-D判别法，函数项级数$\sum \frac{(-1)^{n - 1}}{x^2 + n}$一致收敛。

  \item (6)

        (i)$x \neq 0$时，部分和函数列（等比数列求和）
        \begin{align*}
          S_n(x) & = \sum_{k = 1}^n \frac{x^2}{(1 + x^2)^{k - 1}}                  \\
                 & = \frac{x^2(1 - (\frac{1}{1 + x^2})^n) }{1 - \frac{1}{1 + x^2}} \\
        ...
        \begin{align*}
          \lim\limits_{n \to \infty} S_n(x)
           & = \lim\limits_{n \to \infty} S_n(x)                                \\
           & = \lim\limits_{n \to \infty} 1 + x^2 - \frac{1}{(1 + x^2)^{n - 1}} \\
           & = 1 + x^2
        \end{align*}
        ...
        \begin{align*}
          \sup\limits_{x \neq 0} |S_n(x) - s(x)|
           & = \sup\limits_{x \neq 0} \left|1 + x^2 - \frac{1}{(1 + x^2)^{n - 1}} - (1 + x^2) \right| \\
           & = \sup\limits_{x \neq 0} \frac{1}{(1 + x^2)^{n - 1}}                                     \\
           & = 1
        \end{align*}

        (ii)另外考虑$x = 0$的情况，由上确界的定义可知
        \begin{align*}
          \sup\limits_{x \in (-\infty, +\infty)} |S_n(x) - s(x)| \geq 1
        \end{align*}

        所以
        \begin{align*}
          \lim\limits_{n \to \infty} \sup\limits_{x \in (-\infty, +\infty)} |S_n(x) - s(x)|
           & \neq 0
        \end{align*}
        故函数项级数不一致收敛。
...
已知$g(x)$在$D$上有界，即存在$M > 0$，使得
\begin{align*}
  |g(x)| < M, x \in D
\end{align*}
设$\sum u_n(x)$的部分和函数列为$\{S_n(x)\}$，
已知$\sum u_n(x)$在$D$上一致收敛于$S(x)$，
由一致收敛定义，对任意$\epsilon > 0$，存在$N > 0$，
当$n > N$，对任意$x \in D$，有
\begin{align*}
  |S_n(x) - S(x)| < \epsilon
\end{align*}
...
由一致收敛的定义可知
\begin{align*}
  \sum g(x) u_n(x) = g(x) S(x)
\end{align*}

\section*{5}

$\sum v_n(x)$一致收敛，于是由一致收敛的柯西准则，对任意$\epsilon > 0$，
存在$N$，当$n > N$，以及任意正整数$p$，有
\begin{align*}
  |v_{n+1}(x) + v_{n+2}(x) + \cdots + v_{n+p}(x)| < \epsilon
\end{align*}
由题设可知
\begin{align*}
  |u_{n+1}(x) + v_{n+2}(x) + \cdots + v_{n+p}(x)|
   & \leq |u_{n+1}(x)| + |v_{n+2}(x)| + \cdots + |v_{n+p}(x)| \\
   & \leq v_{n+1}(x) + v_{n+2}(x) + \cdots + v_{n+p}(x)       \\
   & = |v_{n+1}(x) + v_{n+2}(x) + \cdots + v_{n+p}(x)|        \\
   & < \epsilon
\end{align*}
...
$u_n(x)$在$[a,b]$上单调，故
\begin{align*}
  |u_n(x)| \leq |u_n(a)| + |u_n(b)|
\end{align*}

已知$\sum |u_n(a)|$与$\sum |u_n(b)|$收敛，有
\begin{align*}
  \sum |u_n(a)| + |u_n(b)| = \sum |u_n(a)| + \sum |u_n(b)|
\end{align*}
收敛。

由比较原则可知，对任意$x \in [a,b]$，$\sum |u_n(x)|$收敛；

由优级数判别法可知$\sum u_n(x)$一致收敛。
