...
\begin{zremark}
  证明：例1 $\,$中在$x = 0$处的任意阶导数都等于0.
\end{zremark}

\textbf{证明：}

\begin{align*}
  f'(0) & = \lim\limits_{\Delta x \to 0} \frac{f(\Delta x) - f(0)}{\Delta x - 0}    \\
        & = \lim\limits_{\Delta x \to 0} \frac{e^{-\frac{1}{\Delta x^2}}}{\Delta x} 
\end{align*}
令$t = \frac{1}{\Delta x^2}$，当$\Delta x \to 0$，则$t \to \pm \infty$，所以
\begin{align*}
  \lim\limits_{\Delta x \to 0} \frac{e^{-\frac{1}{\Delta x^2}}}{\Delta x} 
  & = \lim\limits_{t \to \pm \infty} \frac{e^{-t^2}}{\frac{1}{t}} \\
  & = \lim\limits_{t \to \pm \infty} \frac{t}{e^{t^2}}
\end{align*}
由洛必达法则可知$\lim\limits_{t \to \pm \infty} \frac{t}{e^{t^2}} = 0$，故
$f'(0) = 0$.
...
\begin{itemize}
  \item 必要性
        ...
        \begin{align*}
          \lim\limits_{n\to\infty} S_n(x) = S(x) = f(x)
        \end{align*}
        从而
        \begin{align*}
