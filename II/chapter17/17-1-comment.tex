...
按照定义，我们只需证明
\begin{align*}
  \lim\limits_{(\Delta x, \Delta y) \to (0, 0)} \frac{\alpha \Delta x + \beta \Delta y}{\rho} = 0 
\end{align*}
因为$(\Delta x, \Delta y) \to (0, 0)$，所以当$\Delta x, \Delta y$足够小时，
\begin{align*}
  | \frac{\alpha \Delta x + \beta \Delta y}{\rho} |
  & = \frac{|\alpha \Delta x + \beta \Delta y|}{\rho} \\
  & \leq \frac{|\alpha \Delta x|  + |\beta \Delta y|}{\rho} \\
\end{align*}
因为
\begin{align*}
...
\begin{align*}
  \frac{|\alpha \Delta x|  + |\beta \Delta y|}{\rho}
  & \leq \frac{|\alpha| \rho  + |\beta| \rho}{\rho} \\
  & = |\alpha| + |\beta|
\end{align*}
综上
\begin{align*}
  \lim\limits_{(\Delta x, \Delta y) \to (0, 0)} \frac{\alpha \Delta x + \beta \Delta y}{\rho}
  & \leq \lim\limits_{(\Delta x, \Delta y) \to (0, 0)} |\alpha| + |\beta| \\
  & = 0
\end{align*}
